      ...
      <div className={`border rounded-lg p-4 mb-3 shadow-sm transition-all ${
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            {lead.referente && (
              <p className="text-sm text-gray-600">📞 {lead.referente}</p>
            )}
          ...
          <div className="mt-3 pt-3 border-t border-gray-200">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              <select
                ...
                className="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                disabled={isUpdating}
              >
              ...
              {/* Campo data se seleziona "da_richiamare" */}
              {(nuovoStato === "da_richiamare" || mostraDataRichiamo) && (
                <div className="flex items-center gap-2 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  ...
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    disabled={isUpdating}
                  />
                </div>
              )}
              ...
              {nuovoStato !== lead.stato_attuale && (
                <button
                  ...
                  disabled={isUpdating}
                  className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50 font-semibold flex items-center justify-center gap-2"
                >
